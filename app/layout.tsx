...
export default function Index() {
    ...
    return (
        <div className={`container mx-auto p-4 max-w-2xl ${darkMode ? 'dark' : ''}`}>
            {/* Header with logo */}
            <header className="flex-col justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700 mb-4">
                <div className="flex items-center justify-center mb-4">
                    <span className="mr-2">Light</span>
                    <button
                        onClick={toggleDarkMode}
                ...
                <nav>
                    <ul className="flex text-2xl space-between space-x-4">
