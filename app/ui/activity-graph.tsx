            ...
            <div className="flex min-w-max lg:min-w-0">
                ...
                <div className="flex">
                    {hoursLabel.map((hour, hourIndex) => (
                        <div key={hourIndex} className="flex flex-col items-center mx-1">
                            <div className="text-xs lg:text-sm w-[40px] text-center">{hour}:00</div>
                            {data.map(([, hours], dayIndex) => (
                                <div key={dayIndex}
                                     className={`mb-1 w-[40px] h-[40px] flex items-center justify-center text-xs lg:text-base dark:text-black ${getColor(hours[hourIndex])}`}>
